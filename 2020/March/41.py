...
def bfs(start: str, graph: dict) -> list:
    """
    Return the lexographically smallest path
    :param start: start node
    :param graph: list of tuples: i.e. [('SFO', 'HKO'), ('YYZ', 'SFO')]
    :return: lexographically smallest path
    """
    paths = []
    visited = []
    queue = [start]
